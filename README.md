...
If you added the marketplace before `v0.2.3`, refresh it first:
...
`v0.2.3` adds user-prompt quality signals and measured-token-aware token effectiveness while keeping raw session prompts out of synthesis payloads. See [CHANGELOG.md](CHANGELOG.md) and [RELEASE_NOTES.md](RELEASE_NOTES.md) for details.
